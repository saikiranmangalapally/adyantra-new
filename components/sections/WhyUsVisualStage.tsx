  ...
  return (
    <div className="relative w-full max-w-[550px] aspect-square flex items-center justify-center mx-auto">
      ...
      >
        ...
        <div>
          <p className="text-xs font-bold text-secondary leading-tight">{reasons?.[0]?.title || "100% In-House"}</p>
          <p className="text-[11px] text-muted-foreground">Premium Quality</p>
        </div>
      </motion.div>
      ...
      >
        ...
        <div>
          ...
          <p className="text-xs font-bold text-secondary mt-0.5">{reasons?.[1]?.title || "98% Retention"}</p>
        </div>
      </motion.div>
      ...
      >
        ...
        <div>
          <p className="text-xs font-bold text-muted-foreground uppercase tracking-wider">Growth Focus</p>
          <p className="text-sm font-extrabold text-secondary">{reasons?.[2]?.title || "Data-Driven ROI"}</p>
        </div>
      </motion.div>
      ...
      >
        ...
        <div>
          <p className="text-xs font-bold text-white leading-tight">{reasons?.[3]?.title || "No Lock-in Terms"}</p>
          <p className="text-[11px] text-slate-300">Total Flexibility</p>
        </div>
      </motion.div>
    </div>
  );
