...
import { Icons8Phone } from "@/components/ui/Icons8Icon";
...
export default function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 transition-all duration-300 px-4 sm:px-8 py-3">
      ...
      <div
        className={`max-w-[1320px] mx-auto rounded-full transition-all duration-300 px-5 sm:px-7 py-2.5 flex items-center justify-between ${
          scrolled || mobileMenuOpen
            ? "bg-white/95 backdrop-blur-xl shadow-[0_10px_30px_-10px_rgba(15,23,42,0.08)] border border-slate-200/80"
            : "bg-white/80 backdrop-blur-xl border border-[rgba(220,230,248,0.55)] shadow-xs"
        }`}
      >
        {/* Brand Logo: Coral Pill + 'adyantra' */}
        <Link href="/" className="flex items-center gap-2.5 shrink-0" onClick={closeMobileMenu}>
          <div className="w-8 h-4 rounded-full bg-[#ef5b52] flex items-center justify-center gap-1 shrink-0">
            <span className="w-1.5 h-1.5 rounded-full bg-white" />
            <span className="w-1.5 h-1.5 rounded-full bg-white" />
          </div>
          <span className="text-[21px] font-bold tracking-tight text-[#0f172a] lowercase font-sans">adyantra</span>
        </Link>

        {/* Desktop Navigation Links */}
        <nav className="hidden lg:flex items-center gap-8 h-full">
          <Link href="/" className="text-[14px] font-medium text-[#0f172a] hover:text-[#ef5b52] transition-colors">
            Home
          </Link>
          ...
          >
            <Link
              ...
              className={`flex items-center gap-1.5 text-[14px] font-medium transition-colors py-2 ${
                activeDropdown === "marketing" ? "text-[#ef5b52]" : "text-[#0f172a] hover:text-[#ef5b52]"
              }`}
            >
              <span>Digital Marketing</span>
              <ChevronDown className={`w-3.5 h-3.5 transition-transform duration-300 ${activeDropdown === "marketing" ? "-rotate-180" : ""}`} />
            </Link>
            ...
            >
              <Link
                href="/ai-automation"
                className={`flex items-center gap-1.5 text-[14px] font-medium transition-colors py-2 ${
                  activeDropdown === "ai" ? "text-[#ef5b52]" : "text-[#0f172a] hover:text-[#ef5b52]"
                }`}
              >
                <span>AI Automation</span>
                <ChevronDown className={`w-3.5 h-3.5 transition-transform duration-300 ${activeDropdown === "ai" ? "-rotate-180" : ""}`} />
              </Link>
            ...
            <Link href="/about" className="text-[14px] font-medium text-[#0f172a] hover:text-[#ef5b52] transition-colors">
              About
            </Link>

            <Link href="/blog" className="text-[14px] font-medium text-[#0f172a] hover:text-[#ef5b52] transition-colors">
              Blog
            </Link>
          </nav>
          ...
          <div className="hidden lg:flex items-center gap-3">
            <a
              ...
              className="w-9 h-9 rounded-full border border-slate-200/80 bg-white flex items-center justify-center text-emerald-500 hover:border-emerald-400 hover:scale-105 transition-all shadow-xs"
            ...
            <Link
              href="/contact"
              className="inline-flex items-center justify-center px-5 py-2.5 rounded-full bg-[#0f172a] text-white text-xs font-semibold uppercase tracking-wider shadow-sm hover:bg-[#ef5b52] transition-all duration-300"
            >
              ...
              <div className="p-5 space-y-3 flex-1">
                ...
                <div className="pt-4 border-t border-slate-100 space-y-2.5">
                  ...
                  <div className="grid grid-cols-2 gap-2 pt-1">
                    ...
                    >
                      <Icons8Phone size={14} color="ef5b52" />
                      <span>Call Now</span>
                    </a>
                    <a
                      href="https://wa.me/918309275093"
